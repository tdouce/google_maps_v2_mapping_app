...
$(document).ready(function(){
    ...
    // the div appropriately.  If you used 'toggle', then the user has to ( for instance if the user
    // previously clicked 'show/hide all') click the table row twice to get the desired effect.
    $('td').click(
        function() {
